...
sidebar: sidebar 
keywords: fas9500, replace a dimm 
summary: 스토리지 시스템에서 Health Monitor 알림을 기반으로 한 과도한 CECC 오류 또는 수정 불가능한 ECC 오류와 같은 오류가 발생하는 경우 컨트롤러의 DIMM을 교체해야 합니다. 이러한 오류는 일반적으로 단일 DIMM 장애로 인해 스토리지 시스템이 ONTAP를 부팅하지 못하게 됩니다. 
---
= DIMM-FAS9500을 교체합니다
:allow-uri-read: 
:icons: font
...
+
image::../media/drw_9500_DIMM_map.svg[시스템 DIMM 맵]
...
+
image::../media/drw_9500_replace_PCM_dimms.svg[DIMM을 교체합니다]
...
+
image::../media/drw_9500_PCM_open.svg[컨트롤러를 닫으세요]
...
+
image::../media/drw_9500_remove_PCM.svg[컨트롤러를 제거하거나 설치하세요]
