...
sidebar: sidebar 
keywords: FAS9500 
summary: NVRAM11 배터리가 포함된 destage 컨트롤러 전원 모듈 DCPM을 핫 스왑하려면 고장난 DCPM 모듈을 찾아 섀시에서 제거한 다음 교체용 DCPM 모듈을 설치해야 합니다. 
---
...
+
image::../media/drw_a900_remove_NV_battery.svg[NV(DCPM) 배터리 교체]
