...
X66240A-5(112-00600), 5m
 a| 
이미지:../media/oie_cable_sfp_gbe_copper.png
 a| 
네트워크 케이블
...
X66100-5(112-00544), 5m
 a| 
이미지:../media/oie_cable100_gbe_qsfp28.png
 a| 
이더넷 데이터, 클러스터 네트워크
...
해당 없음
 a| 
이미지: ../media/oie_cable_micro_usb.pngMicro USB 커넥터]
 a| 
...
| 단계 | 각 컨트롤러에서 수행합니다 
 ...
 a| 
이미지:../media/icon_square_1_green.png
 a| 
케이블 클러스터 인터커넥트 포트:
...
이미지:../media/oie_cable100_gbe_qsfp28.png
 ...
 a| 
이미지:../media/icon_square_2_yellow.png
 a| 
케이블 컨트롤러 관리(렌치) 포트
...
이미지:../media/oie_cable_rj45.png
 ...
 a| 
이미지:../media/icon_square_3_orange.png
 a| 
...
이미지:../media/oie_cable100_gbe_qsfp28.png
 ...
 a| 
이미지:../media/icon_square_4_red.png
 a| 
케이블 25GbE 연결:
...
| 단계 | 각 컨트롤러에서 수행합니다 
 ...
 a| 
image::../media/icon_square_1_blue.png[아이콘 사각형 1 파란색]
 a| 
...
미니 SAS 케이블
 ...
 a| 
image::../media/icon_square_2_yellow.png[아이콘 사각형 2 노란색]
 a| 
