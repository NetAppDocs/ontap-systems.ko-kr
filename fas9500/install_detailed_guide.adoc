...
+
image::../media/drw_autodiscovery_controler_select_ieops-1849.svg[drw autodiscovery controller ieops 1849를 선택합니다]

+
.. 파일 탐색기를 엽니다.
.. 왼쪽 창에서 네트워크 를 클릭하고 마우스 오른쪽 단추를 클릭한 다음 새로 고침 을 선택합니다.
