...
summary: 부팅 미디어 교체가 완료되면 MetroCluster 스위치백 작업을 수행하여 구성을 정상 작동 상태로 되돌리십시오. AFF A700 시스템은 수동 부팅 미디어 복구 절차만 지원합니다. 
---
= AFF A700 시스템의 2노드 MetroCluster 구성에서 애그리게이트를 스위치백합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
