...
---
= AFF A700 시스템의 케이블을 다시 연결하고 디스크를 재할당합니다.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A700 시스템의 컨트롤러 교체를 완료하려면 스토리지 케이블을 다시 연결하고, NetApp Storage Encryption(필요한 경우)을 복원하고, 새 컨트롤러용 라이선스를 설치하십시오.
...
사용하는 절차는 컨트롤러 중복성 구성에 따라 달라집니다.

[role="tabbed-block"]
====
.옵션 1: HA 쌍
--
=== HA 시스템에서 시스템 ID 변경 확인
...
--
.옵션 2: 2노드 MetroCluster
--
=== 2노드 MetroCluster 구성의 시스템에서 시스템 ID를 수동으로 재할당합니다.
