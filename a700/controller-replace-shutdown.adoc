...
summary: 손상된 노드를 종료하려면 노드 상태를 확인하고, 필요한 경우 정상 노드가 손상된 노드 스토리지에서 데이터를 계속 제공할 수 있도록 노드를 인계해야 합니다. 
---
= 교체하기 전에 AFF A700 시스템에서 손상된 컨트롤러를 종료하십시오.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A700 시스템에서 손상된 컨트롤러를 교체하기 전에 해당 구성에 적합한 절차를 사용하여 손상된 컨트롤러를 종료하십시오.
