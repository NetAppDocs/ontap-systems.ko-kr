...
summary: AFF A700 하드웨어 유지 관리 
---
= AFF A700 스토리지 시스템 유지 관리에 대해 알아보기
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
부팅 미디어에는 시스템이 부팅될 때 사용하는 기본 및 보조 부팅 이미지 파일 세트가 저장됩니다. AFF A700 및 FAS9000 시스템은 수동 부팅 미디어 복구 절차만 지원합니다.
