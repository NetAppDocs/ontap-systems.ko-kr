...
[role="lead"]
설치 및 설정 절차는 랙 설치 및 케이블 연결에서 초기 시스템 불러오기에 이르는 일반적인 시스템 설치에 대한 그래픽 지침을 제공합니다. NetApp 시스템 설치에 익숙한 경우 이 가이드를 사용하십시오.

에 액세스합니다 link:../media/PDF/March_2023_Rev1_AFFC400_ISI_IEOPS-1015.pdf["AFF C400 설치 및 설정 지침"^].
