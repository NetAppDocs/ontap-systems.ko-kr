...
---
= 파트너 노드에서 자동 부팅 미디어 복구 - AFF A20, AFF A30 및 AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. 자동 환불 기능이 비활성화된 경우 6단계로 이동하여 다시 활성화하세요.
...
`key manager is configured.`
 a| 
암호화가 설치되었습니다.  4단계로 이동하여 키 관리자를 복원하세요.
...
+
자동 환불 기능이 비활성화된 경우 5단계로 이동하여 다시 활성화하세요.
