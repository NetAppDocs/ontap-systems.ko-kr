...
summary: 교체 요구 사항을 검토하고 컨트롤러를 종료하고 섀시를 교체하고 시스템 작업을 확인하여 AFF A20, AFF A30 또는 AFF A50 스토리지 시스템의 섀시 교체를 시작하십시오. 
---
= AFF A20, AFF A30 및 AFF A50 섀시 교체 워크플로
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
교체 요구 사항을 검토하고 컨트롤러를 종료하고 섀시를 교체하고 시스템 작업을 확인하여 AFF A20, AFF A30 또는 AFF A50 스토리지 시스템의 섀시 교체를 시작하십시오.
