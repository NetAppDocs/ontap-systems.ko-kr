...
summary: 교체 요구 사항을 검토하고, 컨트롤러를 종료하고, 섀시 분리 및 교체, 시스템 작동 확인을 통해 AFF A20, AFF A30 또는 AFF A50 스토리지 시스템의 섀시 교체를 시작하십시오. 
---
...
[role="lead"]
교체 요구 사항을 검토하고, 컨트롤러를 종료하고, 섀시 분리 및 교체, 시스템 작동 확인을 통해 AFF A20, AFF A30 또는 AFF A50 스토리지 시스템의 섀시 교체를 시작하십시오.
