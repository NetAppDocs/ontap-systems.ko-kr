...
summary: 'AFF A20, AFF A30 또는 AFF A50 시스템에서 일반적으로 코인 셀 배터리라고 하는 실시간 클럭(RTC) 배터리를 교체하여 정확한 시간 동기화에 의존하는 서비스와 애플리케이션이 계속 작동하도록 합니다.' 
---
...
[role="lead"]
AFF A20, AFF A30 또는 AFF A50 시스템에서 일반적으로 코인 셀 배터리라고 하는 실시간 클럭(RTC) 배터리를 교체하여 정확한 시간 동기화에 의존하는 서비스와 애플리케이션이 계속 작동하도록 합니다.
