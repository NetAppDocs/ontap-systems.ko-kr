...
sidebar: sidebar 
keywords: AFF A20 specifications, AFF A20 specs, AFF A20 capacity, AFF A20 memory, AFF A20 IO, AFF A20 compliance 
summary: AFF A20의 주요 사양 
---
= AFF A20의 주요 사양
:allow-uri-read: 
:icons: font
...
[role="lead"]
다음은 단일 고가용성 쌍의 AFF A20 스토리지 시스템에 대한 선택 사양입니다.  이 스토리지 시스템의 전체 사양을 보려면 NetApp Hardware Universe (HWU)를 방문하세요.
...
* 유형: NAS; HA 쌍: 3; 원시 용량: 12.1PB / 10.8PiB; 최대 메모리: 384GB
* 유형: SAN; HA 쌍: 3; 원시 용량: 12.1PB / 10.8PiB; 최대 메모리: 384GB
* 유형: HA 쌍; 원시 용량: 4.0 PB / 3.6 PiB; 최대 메모리: 128.0000
...
* 음향 소음: 공칭 음향 출력(LwAd): 8.0; 음압(LpAm)(주변 관찰자 위치): 70.5 dB
