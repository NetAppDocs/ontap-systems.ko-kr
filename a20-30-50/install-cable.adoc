...
---
= AFF A20, AFF A30 또는 AFF A50 하드웨어에 네트워크 및 스토리지 연결을 위한 케이블을 연결하십시오.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:../media/drw_isi_a20_switched_2p_25gbe_cabling_ieops-2019.svg["25GbE IO 모듈 1개를 사용하는 A20 스위치 클러스터 케이블링 다이어그램"]
...
.4포트 10/25GbE I/O 모듈 1개가 있는 AFF A20, AFF A30 또는 AFF A50
...
.4포트 64Gb/s FC I/O 모듈 1개가 장착된 AFF A20, AFF A30 또는 AFF A50
