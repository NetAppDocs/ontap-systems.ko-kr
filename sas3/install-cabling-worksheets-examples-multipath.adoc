...
sidebar: sidebar 
keywords: controller, stack, cable, ha, pair, multipath, configuration, ds212c, ds224c, ds460c 
summary: 컨트롤러-스택 케이블링 워크시트와 예제를 사용하여 HA 쌍을 다중 경로 HA 구성으로 케이블링할 수 있습니다. 
---
= DS212C, DS224C 또는 DS460C 다중 경로 HA 구성을 위한 케이블링 작업표
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
이는 IOM12, IOM12B 또는 IOM12C 모듈이 있는 쉘프에 적용됩니다.
