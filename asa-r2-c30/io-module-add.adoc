...
sidebar: sidebar 
keywords: asa c30, add IO module 
summary: ASA C30 스토리지 시스템에 I/O 모듈을 추가하여 네트워크 연결을 강화하고 시스템의 데이터 트래픽 처리 기능을 확장하세요. 
---
= ASA C30 시스템에 I/O 모듈을 추가하여 네트워크 연결성을 향상시킵니다.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ASA C30 스토리지 시스템에 I/O 모듈을 추가하여 네트워크 연결을 강화하고 시스템의 데이터 트래픽 처리 기능을 확장하세요.
