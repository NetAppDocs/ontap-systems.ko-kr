...
summary: NS224 쉘프를 ASA A800 또는 ASA C800 시스템에 케이블로 연결하여 각 쉘프가 HA 쌍의 각 컨트롤러에 두 개의 연결을 갖도록 하십시오. 
---
= NS224 셸프를 ASA A800 또는 ASA C800 시스템에 케이블로 연결하세요.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
NS224 쉘프를 ASA A800 또는 ASA C800 시스템에 케이블로 연결하여 각 쉘프가 HA 쌍의 각 컨트롤러에 두 개의 연결을 갖도록 하십시오.
