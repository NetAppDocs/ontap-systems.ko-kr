...
summary: NS224 셸프를 AFF A70, AFF A90 또는 AFF C80 시스템에 케이블로 연결하여 각 셸프가 HA 쌍의 각 컨트롤러에 두 개씩 연결되도록 하십시오. 
---
= NS224 쉘프를 AFF A70, AFF A90 또는 AFF C80 시스템에 케이블로 연결합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
NS224 셸프를 AFF A70, AFF A90 또는 AFF C80 시스템에 케이블로 연결하여 각 셸프가 HA 쌍의 각 컨트롤러에 두 개씩 연결되도록 하십시오.
