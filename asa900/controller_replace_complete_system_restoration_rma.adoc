...
sidebar: sidebar 
keywords: asa a900, complete system restoration 
summary: 교체 절차를 완료하고 시스템을 정상 작동 상태로 복원하려면 스토리지 케이블을 다시 연결하고, 필요한 경우 NetApp Storage Encryption 구성을 복원하고, 새 컨트롤러용 라이센스를 설치해야 합니다. 
---
= ASA A900 시스템의 컨트롤러 교체를 완료합니다.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
