...
sidebar: sidebar 
keywords: fas70, fas90, hot swap a cluster ha card, hot swap ethernet client io module, hotswap io module, hot swap io module 
summary: 모듈에 오류가 발생하고 스토리지 시스템이 모든 ONTAP 버전 요구 사항을 충족하는 경우 FAS 70 또는 FAS 90 스토리지 시스템에서 이더넷 I/O 모듈을 핫 스왑할 수 있습니다. 
---
= I/O 모듈 핫 스왑 - FAS 70 및 FAS 90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
모듈에 오류가 발생하고 스토리지 시스템이 모든 ONTAP 버전 요구 사항을 충족하는 경우 FAS 70 또는 FAS 90 스토리지 시스템에서 이더넷 I/O 모듈을 핫 스왑할 수 있습니다.
