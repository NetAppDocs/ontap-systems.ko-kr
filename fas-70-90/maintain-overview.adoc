...
summary: FAS70 및 FAS90 하드웨어를 유지 관리합니다 
---
= FAS70 및 FAS90 하드웨어 유지보수
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
하드웨어에 대한 유지 관리 절차를 수행해야 할 수도 있습니다. 이 섹션에서는 FAS70 및 FAS90 시스템 구성 요소 유지 관리에 대한 절차를 다룹니다.

이 섹션의 절차에서는 FAS70 및 FAS90 시스템이 이미 ONTAP 환경에 스토리지 노드로 구축되어 있다고 가정합니다.
...
팬은 컨트롤러를 냉각시킵니다.
 ...
 a| 
link:caching-module-hot-swap.html["FlashCache"]
 a| 
