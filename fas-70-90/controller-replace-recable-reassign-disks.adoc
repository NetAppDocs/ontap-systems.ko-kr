...
summary: 스토리지 리소스를 교체 컨트롤러로 다시 관리하여 FAS70 또는 FAS90 시스템이 정상 작동을 재개할 수 있도록 합니다. 
---
...
[role="lead"]
스토리지 리소스를 교체 컨트롤러로 다시 관리하여 FAS70 또는 FAS90 시스템이 정상 작동을 재개할 수 있도록 합니다. 반환 절차는 시스템에서 사용하는 암호화 유형(암호화 안 함 또는 Onboard Key Manager(OKM) 암호화)에 따라 다릅니다.
