...
DS460C 선반은 최대 260.4lbs(118.1kg)까지 나갈 수 있습니다. 스토리지 선반을 들어 올리려면 최대 5명이 필요하거나 유압 리프트가 필요할 수 있습니다. 선반의 무게 균형을 유지하기 위해 스토리지 선반의 모든 구성품(앞쪽과 뒤쪽 모두)을 선반 안에 넣어 두십시오.
