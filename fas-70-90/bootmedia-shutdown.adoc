...
summary: 수동 부팅 미디어 복구 프로세스 동안 데이터 손실을 방지하고 시스템 안정성을 유지하려면 FAS70 또는 FAS90 스토리지 시스템에서 손상된 컨트롤러를 종료하세요. 
---
= 수동 부팅 미디어 복구를 위해 컨트롤러 종료 - FAS70 및 FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
수동 부팅 미디어 복구 프로세스 동안 데이터 손실을 방지하고 시스템 안정성을 유지하려면 FAS70 또는 FAS90 스토리지 시스템에서 손상된 컨트롤러를 종료하세요.
