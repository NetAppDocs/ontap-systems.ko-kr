...
summary: 손상된 섀시를 식별하고, 교체 구성 요소를 확인하고, 케이블과 컨트롤러 모듈에 라벨을 붙여 FAS70 및 FAS90 시스템에서 손상된 섀시를 교체할 준비를 합니다. 
---
= 섀시 교체 준비 - FAS70 및 FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
손상된 섀시를 식별하고, 교체 구성 요소를 확인하고, 케이블과 컨트롤러 모듈에 라벨을 붙여 FAS70 또는 FAS90 시스템에서 손상된 섀시를 교체할 준비를 합니다.
...
.다음 단계
FAS70 또는 FAS90 섀시 하드웨어를 교체할 준비가 되면 다음을 수행해야 합니다.link:chassis-replace-shutdown.html["컨트롤러를 종료합니다"] .
