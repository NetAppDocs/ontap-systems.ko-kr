...
sidebar: sidebar 
keywords: fas70, fas90, add IO module 
summary: FAS70 및 FAS90 시스템에 IO 모듈을 추가하여 네트워크 연결을 강화하고 시스템의 데이터 트래픽 처리 능력을 확장하십시오. 
---
...
[role="lead"]
FAS70 및 FAS90 시스템에 I/O 모듈을 추가하여 네트워크 연결을 향상하고 데이터 트래픽 처리 기능을 확장하십시오.
