...
summary: 정확한 시간 동기화에 의존하는 시스템의 서비스 및 애플리케이션이 계속 작동하도록 컨트롤러 모듈의 실시간 클록 RTC 배터리를 교체합니다. 
---
= 실시간 시계 배터리 교체 - FAS2820
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_2850_open_controller_module_cover_IEOPS-695.svg[컨트롤러 커버를 제거하세요]
...
RTC 배터리를 컨트롤러 내부에 찾아서 교체하고 특정 단계를 따릅니다.

.애니메이션 - RTC 배터리를 교체합니다
video::7420d100-23b1-4213-a8da-af4701725622[panopto]
image::../media/drw_2850_replace_rtc_battery_IEOPS-701.svg[RTC 배터리를 교체합니다]
...
컨트롤러 모듈을 다시 설치하고 LOADER 프롬프트로 부팅합니다.
