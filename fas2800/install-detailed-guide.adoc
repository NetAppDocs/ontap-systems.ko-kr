...
NOTE: 시스템에 외부 쉘프가 없는 경우 link:../sas3/install-cabling-worksheets-examples-fas2600.html#fas2820-platform-in-a-multipath-ha-configuration-with-no-external-shelves["외부 셸프가 없는 다중 경로 HA 구성에서 FAS2820의 케이블 연결 지침"]을(를) 참조하십시오.
