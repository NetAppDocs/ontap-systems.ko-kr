...
+
** 명령 출력에 <lno-DARE> 또는 <1Ono-dARE>가 표시되면 시스템이 NVE를 지원하지 않는 것입니다. 로 진행합니다 https://docs.netapp.com/us-en/ontap-systems/fas2800/bootmedia-impaired-controller-shutdown.html["손상된 컨트롤러를 종료합니다"].
