...
|===
 ...
 a| 
image:../media/icon_round_1.png["설명선 번호 1"]
| 배터리 하우징에서 탭을 천천히 당겨 빼냅니다. 참고: 이 탭을 적극적으로 당겨 빼내면 탭이 대체할 수 있습니다. 
...
[[step-4-reinstall-the-controller-module-and-set-timedate-after-rtc-battery-replacement]]
