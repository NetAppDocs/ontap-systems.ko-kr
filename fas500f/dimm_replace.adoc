...
link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=fa6b8107-86fb-4332-aa57-ac5b01605e52["DIMM 교체"^]
...
NOTE: 각 DIMM 옆에 있는 보드에 있는 오류 LED가 2초 간격으로 깜박입니다.
