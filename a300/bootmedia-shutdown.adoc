...
summary: 스토리지 시스템 하드웨어 구성에 따라 서로 다른 절차를 사용하여 손상된 컨트롤러를 종료하거나 제어권을 확보할 수 있습니다. AFF A300 시스템은 수동 부팅 미디어 복구 절차만 지원합니다. 
---
= AFF A300 시스템에서 수동 부팅 복구 과정 중에 손상된 컨트롤러를 종료하십시오.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
구성에 맞는 절차를 사용하여 손상된 컨트롤러를 종료하거나 제어권을 인계받으십시오. AFF A300 시스템은 수동 부팅 미디어 복구 절차만 지원합니다. 자동 부팅 미디어 복구는 지원되지 않습니다.
