...
summary: 섀시를 교체하려면 컨트롤러를 종료해야 합니다. 이 절차는 중단을 따릅니다. 2노드 클러스터의 경우, 다중 노드 클러스터의 서비스 중단이 완전히 완료되고 부분 중단이 발생할 것입니다. 
---
= 컨트롤러 종료 - AFF A300
:icons: font
:imagesdir: ../media/
...
== 옵션 2: 컨트롤러는 2노드 MetroCluster에 있습니다
