...
[role="lead"]
AFF A300 시스템의 섀시 교체를 완료하려면 섀시의 HA 상태를 확인하고, 필요한 경우 애그리게이트를 다시 전환하고, 고장난 구성 요소를 NetApp에 반환합니다.
...
독립형 구성
 a| 
.. 유지보수 모드를 종료합니다
.. 로 이동합니다 <<3단계: 장애가 발생한 부품을 NetApp에 반환>>.
