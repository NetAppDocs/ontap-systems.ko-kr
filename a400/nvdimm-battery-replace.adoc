...
[role="lead"]
AFF A400 시스템의 NVDIMM 배터리는 충전량이 줄어들거나 고장 나기 시작하면 교체해야 합니다. 교체 과정은 컨트롤러 모듈을 분리하고, 배터리를 교체한 후 컨트롤러 모듈을 다시 설치하는 것입니다.
...
image::../media/drw_A400_nvdimm-batt_IEOPS-1004.svg[NVDIMM 배터리를 교체합니다]
