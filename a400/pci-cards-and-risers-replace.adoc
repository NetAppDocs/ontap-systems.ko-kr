...
---
= AFF A400 시스템의 PCIe 또는 메자닌 카드 교체
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A400 시스템의 PCIe 또는 메자닌 카드가 고장 나거나 업그레이드가 필요한 경우 교체하십시오. 교체 과정은 케이블과 SFP 또는 QSFP 모듈을 분리하고, 새 카드로 교체한 후 케이블을 다시 연결하는 것으로 구성됩니다.
