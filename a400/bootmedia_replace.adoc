...
---
= 컨트롤러 모듈을 분리하고 부팅 미디어를 교체한 다음 부팅 이미지를 부팅 미디어-AFF A400으로 전송합니다
:icons: font
:imagesdir: ../media/
...
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=e0825a97-c57d-47d7-b87d-aad9012efa12["부팅 미디어를 교체합니다"]
...
. 환경 변수와 boots는 그대로 유지되지만, 'printenv boottar name' 명령을 사용하여 시스템 유형 및 구성에 필요한 모든 부트 환경 변수와 boots가 올바르게 설정되어 있는지 확인하고 'etenv_variable-name_<value>' 명령을 사용하여 오류를 수정해야 합니다.
+
.. 부팅 환경 변수를 확인합니다.
+
