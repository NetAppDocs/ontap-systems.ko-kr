...
---
= 자세한 단계를 사용하여 AFF A220 스토리지 시스템을 설치합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A220 스토리지 시스템 랙 설치 및 케이블 연결부터 초기 시스템 가동까지, 자세한 단계별 지침에 따라 설치하십시오.
...
AFF A220 시스템을 설치하려면 NetApp Support 사이트에서 계정을 만들고 시스템을 등록하고 라이센스 키를 받아야 합니다. 또한 시스템에 맞는 케이블 수와 유형을 확인하고 특정 네트워크 정보를 수집해야 합니다.
...
image:../media/drw_c190_u_tnsc_clust_cbling.png["클러스터 인터커넥트 케이블 연결"]
 ...
 a| 
image:../media/icon_square_2_orange.png["2단계"]
 a| 
...
** e0a ~ e0a
** e0b ~ e0b image:../media/drw_c190_e_tnsc_clust_cbling.png["컨트롤러 후면의 포트 간 클러스터 상호 연결"]
...
image:../media/drw_c190_e_mgmt_cbling.png["관리 포트 케이블 연결"]
...
image:../media/drw_c190_e_switched_clust_cbling.png["클러스터 인터커넥트 케이블 연결"]
...
+
image::../media/drw_2700_ha_storage_cabling_animated_gif.png[HA 쌍의 쉘프 케이블 연결]
...
image:../media/oie_cable_mini_sas_hd_to_mini_sas_hd.png["미니 SAS - 미니 SAS 커넥터"]     미니 SAS HD - 미니 SAS HD 케이블
 ...
 a| 
image:../media/icon_square_3_tourquoise.png["3단계"]
 a| 
