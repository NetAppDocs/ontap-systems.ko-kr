...
[role="lead"]
이 페이지에서는 일반적인 NetApp 시스템 설치를 위한 자세한 단계별 지침을 제공합니다.
...
** e0a ~ e0a
** e0b ~ e0b
image:../media/drw_c190_e_tnsc_clust_cbling.png["컨트롤러 후면의 포트 간 클러스터 인터커넥트를 보여주는 그림입니다"]
...
| 단계 | 각 컨트롤러에서 수행합니다 
 ...
 a| 
image:../media/oie_legend_icon_1_lo.png["설명선 번호 1"]
 a| 
...
image:../media/oie_cable_mini_sas_hd_to_mini_sas_hd.png["미니 SAS - 미니 SAS 커넥터"]     미니 SAS HD - 미니 SAS HD 케이블
 ...
 a| 
image:../media/oie_legend_icon_2_mb.png["2단계"]
 a| 
...
image:../media/oie_cable_mini_sas_hd_to_mini_sas_hd.png["미니 SAS - 미니 SAS 커넥터"]     미니 SAS HD - 미니 SAS HD 케이블
 ...
 a| 
image:../media/oie_legend_icon_3_t.png["3단계"]
 a| 
