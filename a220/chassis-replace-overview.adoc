...
---
= AFF A220 섀시를 교체하기 전에 요구 사항을 검토하십시오
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A220 시스템의 섀시를 교체하기 전에 성공적인 교체를 위한 요구 사항을 검토하십시오. 섀시 교체 절차는 손상된 섀시에서 교체 섀시로 모든 전원 공급 장치, 드라이브 및 컨트롤러 모듈을 이동하며 시스템 운영에 지장을 줄 수 있습니다.
