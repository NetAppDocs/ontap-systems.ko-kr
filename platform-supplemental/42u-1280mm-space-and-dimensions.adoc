...
image::../media/drw_sys_cab_side_front_dimensions_ozeki.gif[시스템 캐비닛의 전면 후면 및 측면 모습]
...
image::../media/drw_ozeki_sys_cab_bottom_top_dimensions_ieops-1803.svg[시스템 캐비닛의 상단 및 하단 모습]
