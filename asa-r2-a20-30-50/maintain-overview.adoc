...
[role="lead"]
하드웨어에 대한 유지 관리 절차를 수행해야 할 수도 있습니다. ASA A20, ASA A30 및 ASA A50 시스템 구성 요소의 유지 관리에 대한 절차는 이 섹션에 나와 있습니다.

이 섹션의 절차는 ASA A20, ASA A30 또는 ASA A50 스토리지 시스템이 ONTAP 환경에 스토리지 노드로 이미 구축되어 있다고 가정합니다.
