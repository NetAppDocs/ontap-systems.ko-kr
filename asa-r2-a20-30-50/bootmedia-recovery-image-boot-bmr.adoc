...
summary: ASA A20, ASA A30 또는 ASA A50 스토리지 시스템에 새 부팅 미디어 장치를 설치한 후 자동 부팅 미디어 복구 프로세스를 시작하여 정상 노드에서 구성을 복원할 수 있습니다. 
---
= 부팅 미디어에서 ASA A20, ASA A30 및 ASA A50의 ONTAP 이미지를 복원합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
