...
summary: 모듈에 장애가 발생하고 스토리지 시스템이 모든 ONTAP 버전 요구 사항을 충족하는 경우 ASA A20, ASA A30 또는 ASA A50 스토리지 시스템에서 이더넷 I/O 모듈을 핫 스왑할 수 있습니다. 
---
= ASA A20, ASA A30 또는 ASA A50 시스템에서 시스템을 종료하지 않고 I/O 모듈을 핫스왑합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
모듈에 장애가 발생하고 스토리지 시스템이 모든 ONTAP 버전 요구 사항을 충족하는 경우 ASA A20, ASA A30 또는 ASA A50 스토리지 시스템에서 이더넷 I/O 모듈을 핫 스왑할 수 있습니다.
