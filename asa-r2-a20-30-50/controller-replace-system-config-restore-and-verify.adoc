...
summary: 컨트롤러의 HA 구성이 활성 상태이고 ASA A20, ASA A30 또는 ASA A50 스토리지 시스템에서 올바르게 작동하는지 확인하고 시스템 어댑터에 디스크의 모든 경로가 표시되는지 확인합니다. 
---
= ASA A20, ASA A30 또는 ASA A50 시스템에서 컨트롤러 구성을 복원하고 확인합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
