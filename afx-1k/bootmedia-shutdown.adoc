...
summary: 부팅 미디어를 교체할 때 데이터 손실을 방지하고 시스템 안정성을 확보하려면 AFX 1K 스토리지 시스템에서 손상된 컨트롤러를 종료하세요. 
---
= 자동 부팅 복구 프로세스 중에 AFX 1K 스토리지 시스템의 컨트롤러를 종료하십시오.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
부팅 미디어를 교체할 때 데이터 손실을 방지하고 시스템 안정성을 확보하려면 AFX 1K 스토리지 시스템에서 손상된 컨트롤러를 종료하세요.
...
.다음 단계
컨트롤러를 종료한 후,link:bootmedia-replace.html["부팅 미디어를 변경하세요"] .
