...
summary: 섀시를 교체할 때 데이터 손실을 방지하고 시스템 안정성을 확보하려면 AFX 1K 스토리지 시스템의 컨트롤러를 종료하세요. 
---
= 섀시를 교체하기 위해 AFX 1K 컨트롤러를 종료합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
섀시를 교체할 때 데이터 손실을 방지하고 시스템 안정성을 확보하려면 AFX 1K 스토리지 시스템의 컨트롤러를 종료하세요.
