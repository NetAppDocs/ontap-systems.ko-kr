---
permalink: afx-2k/bootmedia-recovery-image-boot.html 
sidebar: sidebar 
keywords: afx 2k, boot the recovery image 
summary: 새 부팅 미디어 장치를 AFX 2K 스토리지 시스템에 설치한 후 자동 부팅 미디어 복구 프로세스를 시작하여 파트너 노드에서 구성을 복원할 수 있습니다. 
---
= 자동 부팅 복구 프로세스를 사용하여 AFX 2K 스토리지 시스템에서 복구 이미지를 부팅합니다.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
새 부팅 미디어 장치를 AFX 2K 스토리지 시스템에 설치한 후 자동 부팅 미디어 복구 프로세스를 시작하여 파트너 노드에서 구성을 복원할 수 있습니다.
...
+
이 프로세스는 파트너 노드에서 적절한 파일을 복원하고 노드를 재부팅합니다. 다음 단계로 넘어가세요.
