...
summary: 컨트롤러를 재부팅하고 시스템 상태를 확인한 후, 고장난 부품을 NetApp에 반환하여 AFX 2K 섀시 교체 절차의 최종 단계를 완료하십시오. 
---
= AFX 2K 스토리지 시스템의 섀시 교체를 완료합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
컨트롤러를 재부팅하고 시스템 상태를 확인한 후, 고장난 부품을 NetApp에 반환하여 AFX 2K 섀시 교체 절차의 최종 단계를 완료하십시오.
