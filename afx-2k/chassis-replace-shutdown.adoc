...
summary: 데이터 손실을 방지하고 섀시 교체 시 시스템 안정성을 확보하기 위해 afx 2k 스토리지 시스템의 컨트롤러를 종료합니다. 
---
= 섀시 교체를 위해 컨트롤러를 종료합니다 - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFX 2K 스토리지 시스템에서 컨트롤러를 종료하여 섀시 교체 시 데이터 손실을 방지하고 시스템 안정성을 확보합니다.
