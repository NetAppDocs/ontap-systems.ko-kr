...
.이 작업에 대해
이 절차는 AFX 2K 컨트롤러의 슬롯 4 및 5에 있는 NVRAM 모듈의 고장난 NV 배터리 교체에 적용됩니다. AFX 2K 컨트롤러의 슬롯 6 및 7에 있는 NVRAM12-EX 모듈의 NV 배터리 교체 방법에 대한 자세한 내용은 link:../install-setup/nv12l-replace.html#step-2-replace-the-nvram12-ex-module-nvram-dimm-or-nvram-battery["NVRAM12-EX의 NV 배터리 교체"]을 참조하십시오.
