...
summary: afx 2k 스토리지 시스템에서 손상된 섀시를 교체할 준비를 하려면 손상된 섀시를 식별하고, 교체 구성 요소를 확인하고, 케이블과 컨트롤러 모듈에 레이블을 붙여야 합니다. 
---
= 섀시 교체 준비 - AFX 2K
:allow-uri-read: 
:icons: font
...
[role="lead"]
AFX 2K 스토리지 시스템에서 손상된 섀시를 교체할 준비를 하려면 손상된 섀시를 식별하고, 교체 구성 요소를 확인하고, 케이블과 컨트롤러 모듈에 라벨을 붙여야 합니다.
...
.다음 단계
AFX 2K 섀시 하드웨어 교체를 준비한 후 link:chassis-replace-shutdown.html["컨트롤러를 종료합니다"]해야 합니다.
