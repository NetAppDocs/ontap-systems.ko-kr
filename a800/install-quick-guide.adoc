...
[role="lead"]
이 안내서는 랙 설치 및 케이블 연결에서부터 초기 시스템 시작까지 시스템을 설치하는 일반적인 방법에 대한 그래픽 지침을 제공합니다. 를 사용합니다 link:../media/PDF/215-13082_2022-08_us-en_AFFA800_ISI.pdf["AFF A800 설치 및 설정 지침"^] NetApp 시스템 설치에 익숙한 경우
