...
.단계
. 애니메이션 또는 표 형식 단계를 사용하여 컨트롤러와 스위치 간 케이블 연결을 완료합니다. 비디오: edc42447-f721-4cbe-b080-ab0c0123a139 [panopto, title="2-노드 스위치 없는 클러스터 케이블 연결"]
+
[cols="10,90"]
|===
...
.단계
. 애니메이션 또는 표 형식 단계를 사용하여 컨트롤러와 스위치 사이의 케이블 연결을 완료합니다. 비디오: 49e48140-4c5a-4395-a7d7-ab0c0123a10e [팬토어, 제목="스위치 클러스터 케이블 연결"]
+
[cols="10,90"]
|===
| 단계 | 각 컨트롤러 모듈에서 수행합니다 
