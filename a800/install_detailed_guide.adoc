...
. 필요에 따라 레일 키트를 설치합니다.
+
link:../com.netapp.doc.hw-rail-superrail/home.html["4-포스트 랙에 SuperRail 설치"^]
...
.단계
. 애니메이션(link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=edc42447-f721-4cbe-b080-ab0c0123a139["스위치가 없는 2노드 클러스터를 케이블로 연결합니다"^]) 또는 컨트롤러와 스위치 간의 케이블 연결을 완료하기 위한 단계별 지침:
+
[cols="10,90"]
|===
...
.단계
. 애니메이션(link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=49e48140-4c5a-4395-a7d7-ab0c0123a10e["스위치 클러스터 케이블 연결"^]) 또는 컨트롤러와 스위치 간의 케이블 연결을 완료하기 위한 단계별 지침:
+
[cols="10,90"]
|===
| 단계 | 각 컨트롤러 모듈에서 수행합니다 
...
.단계
. 애니메이션(link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=09dade4f-00bd-4d41-97d7-ab0c0123a0b4["단일 드라이브 쉘프에 컨트롤러 케이블 연결"^] 또는 컨트롤러 모듈을 단일 쉘프에 케이블로 연결하기 위한 단계별 지침을 제공합니다.
+
[cols="10,90"]
|===
| 단계 | 각 컨트롤러 모듈에서 수행합니다 
...
.단계
. 다음 애니메이션(link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=fe50ac38-9375-4e6b-85af-ab0c0123a0e0["2개의 드라이브 쉘프에 컨트롤러 케이블 연결"^]) 또는 2개의 드라이브 쉘프에 컨트롤러를 케이블로 연결하기 위한 서면 단계
+
[cols="10,90"]
|===
| 단계 | 각 컨트롤러 모듈에서 수행합니다 
...
. 다음 애니메이션(link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=d61f983e-f911-4b76-8b3a-ab1b0066909b["관리 스위치에 랩톱 연결"^])를 클릭하여 노트북을 관리 스위치에 연결합니다.
