...
---
= 플랫폼 제품군별 NVMEM 또는 NVRAM 배터리 교체 절차
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.AFX 시스템
--
* link:../afx-1k/nvdimm-battery-replace.html["AFX 1K"]
* link:../afx-2k/nvdimm-battery-replace.html["AFX 2K"]
...
* link:../fas500f/nvmem-nvram-battery-replace.html["500f로 설정합니다"]
