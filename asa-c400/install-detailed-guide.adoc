...
---
= 자세한 단계를 사용하여 ASA C400 스토리지 시스템을 설치합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_c400_TNSC-networking-cabling_IEOPS-1095.svg[drw C400 TNSC 네트워킹 케이블 연결 IEOPS 1095]
...
. 그림을 사용하여 컨트롤러와 스위치 간의 케이블 연결을 완료합니다.
+
image::../media/drw_c400_switched_network_cabling_IEOPS-1096.svg[drw C400 스위치 네트워크 케이블 연결 IEOPS 1096]
...
+
image::../media/drw_c400_one_ns224_shelf_IEOPS-1097.svg[drw C400 1개 ns224 쉘프 IEOPS 1097]
...
+
image::../media/drw_c400_two_ns224_shelves_IEOPS-1098.svg[drw C400 2개 ns224 쉘프 IEOPS 1098]
