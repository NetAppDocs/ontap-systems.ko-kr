...
summary: ASA C400 스토리지 시스템의 컨트롤러를 교체할 때 데이터 손실을 방지하고 시스템 안정성을 확보하려면 컨트롤러를 종료하십시오. 
---
= 교체하기 전에 ASA C400 시스템에서 손상된 컨트롤러를 종료하십시오.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ASA C400 스토리지 시스템의 컨트롤러를 교체할 때 데이터 손실을 방지하고 시스템 안정성을 확보하려면 컨트롤러를 종료하십시오.
...
====
.다음 단계
ASA C400 컨트롤러를 종료한 후에는 link:controller-replace-move-hardware.html["컨트롤러를 교체합니다"]해야 합니다.
