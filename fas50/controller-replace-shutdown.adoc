...
summary: FAS50 스토리지 시스템에서 손상된 컨트롤러를 종료하여 데이터 손실을 방지하고 컨트롤러 교체 시 시스템 안정성을 보장합니다. 
---
= 손상된 컨트롤러-FAS50을 종료합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS50 스토리지 시스템에서 손상된 컨트롤러를 종료하여 데이터 손실을 방지하고 컨트롤러 교체 시 시스템 안정성을 보장합니다.
