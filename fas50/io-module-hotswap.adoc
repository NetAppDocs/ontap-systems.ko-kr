...
summary: 모듈에 오류가 발생하고 스토리지 시스템이 모든 ONTAP 버전 요구 사항을 충족하는 경우 FAS50 스토리지 시스템에서 Ethernet I/O 모듈을 핫 스왑할 수 있습니다. 
---
= I/O 모듈 핫 스왑 - FAS50
:allow-uri-read: 
:icons: font
...
[role="lead"]
모듈에 오류가 발생하고 스토리지 시스템이 모든 ONTAP 버전 요구 사항을 충족하는 경우 FAS50 스토리지 시스템에서 Ethernet I/O 모듈을 핫 스왑할 수 있습니다.
