...
summary: FAS50 스토리지 시스템에서 손상된 컨트롤러를 종료하여 데이터 손실을 방지하고 부팅 미디어 교체 시 시스템 안정성을 유지합니다. 
---
= 부팅 미디어를 교체하려면 컨트롤러를 종료합니다. - FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS50 스토리지 시스템에서 손상된 컨트롤러를 종료하여 데이터 손실을 방지하고 부팅 미디어 교체 시 시스템 안정성을 유지합니다.
