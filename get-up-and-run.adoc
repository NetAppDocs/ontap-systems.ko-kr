...
시스템이 MetroCluster 구성인 경우 로 이동합니다 https://["MetroCluster 문서 사이트"] MetroCluster 구성 유형에 해당하는 설치 지침을 따르십시오.
...
랙 또는 캐비닛에 AFF/FAS 컨트롤러 설치 AFF/FAS 플랫폼 모델의 설치 및 설정 지침에 액세스합니다. 모든 SAN 어레이(ASA) 시스템의 경우 해당 AFF A 시리즈 모델의 설치 지침을 따르십시오.
...
[role="quick-margin-list"]
* ONTAP 배포의 경우 를 참조하십시오 https://["ONTAP를 구성합니다"].
* MetroCluster 배포를 지원하는 ONTAP의 경우 를 참조하십시오 https://["ONTAP를 사용하여 MetroCluster를 구성합니다"].
