...
* link:https://docs.netapp.com/us-en/ontap-systems-switches/afx/index.html["AFX 스위치"^]
* link:https://review.docs.netapp.com/us-en/ontap-systems-switches/cluster/index.html["클러스터 스위치"^]
* link:https://review.docs.netapp.com/us-en/ontap-systems-switches/storage/index.html["스토리지 스위치"^]
* link:https://docs.netapp.com/us-en/ontap-systems-switches/switch-cisco-9336c-fx2-shared/install-9336c-shared.html["공유 스위치"^]
...
[role="quick-margin-list"]
* link:aff-aseries/index.html["AFF A-Series 시스템"]
* link:aff-cseries/index.html["AFF C-Series 시스템"]
* link:allsan-landing/index.html["ASA 시스템"]
* link:https://docs.netapp.com/us-en/ontap-afx/install-setup/install-setup-workflow.html["AFX 시스템"]
* https://docs.netapp.com/us-en/asa-r2/install-setup/install-setup-workflow.html["ASA r2 시스템"]
...
[role="quick-margin-list"]
* ONTAP 배포에 대해서는 다음을 참조하세요. https://docs.netapp.com/us-en/ontap/task_configure_ontap.html["ONTAP를 구성합니다"^] .
* MetroCluster 배포를 사용한 ONTAP 의 경우 다음을 참조하세요. https://docs.netapp.com/us-en/ontap-metrocluster/["ONTAP를 사용하여 MetroCluster를 구성합니다"^] .
