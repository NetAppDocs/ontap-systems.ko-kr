...
sidebar: sidebar 
keywords: nx224, shelves, shelf, nx224 shelves, replace, impair, nvme, module, nsm, nondisruptive, drive, io, nsm, replace an NSM 
...
CAUTION: 손상된 NSM 커버를 닫기 전에 모든 빈 DIMM 슬롯의 이젝터 탭이 잠금 위치로 완전히 돌아갔는지 확인하십시오.
