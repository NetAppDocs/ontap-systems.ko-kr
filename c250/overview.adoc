...
[role="lead"]
다음은 단일 고가용성 쌍의 AFF C250 스토리지 시스템에 대한 선택 사양입니다.  이 스토리지 시스템의 전체 사양을 보려면 NetApp Hardware Universe (HWU)를 방문하세요.
...
* 유형: NAS; HA 쌍: 12; 원시 용량: 17.7PB / 15.7PiB; 최대 메모리: 1536GB
