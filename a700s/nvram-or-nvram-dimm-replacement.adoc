...
sidebar: sidebar 
keywords: aff a700s, aff, a700s, replace, fail, nvram, card, remove, riser, controller, module, system, id, nvram, dimm, shut, down, reassign, disk, restore, encryption, functionality, complete, replacement 
...
---
= AFF A700s 시스템의 NVRAM 모듈 및 NVRAM DIMM 교체
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A700s 시스템에서 NVRAM 모듈과 NVRAM DIMM을 교체하려면 NVRAM 라이저를 제거하고, 고장난 카드를 교체한 다음, 라이저를 다시 설치하십시오.
