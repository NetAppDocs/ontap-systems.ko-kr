...
[role="lead"]
AFF A700s 시스템의 팬을 교체하려면 고장난 팬 모듈을 제거하고 새 팬 모듈을 설치하십시오.



[[step-1-shut-down-the-impaired-controller-aff-a700s]]
== 1단계: 장애가 있는 컨트롤러 종료 - AFF A700s
...
== 5단계: 장애가 발생한 부품을 NetApp-AFF A700으로 되돌립니다
