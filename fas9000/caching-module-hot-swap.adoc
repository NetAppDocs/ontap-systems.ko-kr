...
summary: 'NVMe SSD Flash Cache 모듈(플래시 캐시 또는 캐싱 모듈)은 FAS9000 시스템의 슬롯 6에 있는 NVRAM10 모듈 전면에 있습니다. ONTAP 9.4부터는 동일하거나 다른 지원되는 공급업체에서 동일한 용량의 캐시 모듈을 핫 스왑할 수 있습니다.' 
---
...
[role="lead"]
NVMe SSD Flash Cache 모듈(플래시 캐시 또는 캐싱 모듈)은 FAS9000 시스템의 슬롯 6에 있는 NVRAM10 모듈 전면에 있습니다. ONTAP 9.4부터는 동일하거나 다른 지원되는 공급업체에서 동일한 용량의 캐시 모듈을 핫 스왑할 수 있습니다.
