...
summary: NIC 또는 스토리지 어댑터를 완전히 채워진 시스템의 새 NIC 또는 스토리지 어댑터로 교체하거나 시스템의 빈 섀시 슬롯에 새 NIC 또는 스토리지 어댑터를 추가하여 시스템에 입출력 모듈을 추가할 수 있습니다. 
---
= X91148A 모듈 추가 개요 - AFF A9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
