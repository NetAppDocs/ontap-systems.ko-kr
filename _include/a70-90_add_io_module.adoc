...
NOTE: DC PSU가 있는 경우 케이블 블록을 PSU에 다시 연결합니다.
...
. 스토리지 I/O 모듈을 설치한 경우 에 설명된 대로 NS224 쉘프를 설치하고 연결합니다. https://docs.netapp.com/us-en/ontap-systems/ns224/hot-add-shelf.html["핫 - 쉘프 추가"^]
...
NOTE: 기억 장치 시스템에 DC 전원 공급 장치가 있는 경우, PSU에서 전원 케이블 블록을 분리하십시오.
