...
sidebar: sidebar 
keywords: fas8300, fas8700, nvdimm, battery, remove, controller, module, node, metrocluster, configuration, diagnostics, aggregate, configuration, reinstall, run, system, switch, shut, down 
...
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=1f1425a8-5a91-4810-82da-aad9012efa4f["NVDIMM 배터리를 교체합니다"]
...
** 검사에 오류가 없는 경우 메뉴에서 "재부팅"을 선택하여 시스템을 재부팅합니다.
