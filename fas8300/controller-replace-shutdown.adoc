...
summary: 데이터 손실을 방지하고 시스템 안정성을 확보하려면 FAS8300 및 FAS8700 스토리지 시스템의 컨트롤러를 교체할 때 컨트롤러를 종료하십시오. 
---
= 손상된 컨트롤러 - FAS8300 및 FAS8700을 종료합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
데이터 손실을 방지하고 시스템 안정성을 확보하려면 FAS8300 및 FAS8700 스토리지 시스템의 컨트롤러를 교체할 때 컨트롤러를 종료하십시오.
...
====
.다음 단계
FAS8300 및 FAS8700 컨트롤러를 종료한 후에는 link:controller-replace-move-hardware.html["컨트롤러를 교체합니다"]해야 합니다.
