...
summary: 'FAS8300 및 FAS8700 시스템의 컨트롤러 교체를 완료하십시오. 교체 컨트롤러에 대한 라이센스를 설치하고, 논리 인터페이스(LIF)가 홈 포트에 보고하는지 확인하고, 클러스터 상태 점검을 수행하십시오. 마지막으로 장애가 발생한 부품을 NetApp에 반환하십시오.' 
---
= 컨트롤러 전체 교체 - FAS8300 및 FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS8300 및 FAS8700 시스템의 컨트롤러 교체를 완료하십시오. 교체 컨트롤러에 대한 라이센스를 설치하고, 논리 인터페이스(LIF)가 홈 포트에 보고하는지 확인하고, 클러스터 상태 점검을 수행하십시오. 마지막으로 장애가 발생한 부품을 NetApp에 반환하십시오.
