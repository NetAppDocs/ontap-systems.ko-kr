...
[role="lead"]
NVDIMM을 교체하려면 공기 덕트 상단의 FRU 맵을 사용하여 컨트롤러 모듈에서 찾을 수도 있고 슬롯 1 라이저 상단에 있는 FRU 맵을 사용하여 주의 LED를 찾아야 합니다.
...
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=e0afec49-0953-4dcc-b9d0-aadb01578e1b["NVDIMM 교체"]
