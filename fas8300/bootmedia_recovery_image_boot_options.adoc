...
sidebar: sidebar 
keywords: fas8300, fas8300, procedure, boot, impair, node, recovery, image, system, two-node, metrocluster, configuration, boot the recovery image 
summary: 복구 이미지에서 손상된 노드를 부팅하는 절차는 시스템이 2노드 MetroCluster 구성에 있는지 여부에 따라 다릅니다. 
---
= 복구 이미지를 부팅합니다. - AFF FAS8300 및 FAS8700
:icons: font
:imagesdir: ../media/
