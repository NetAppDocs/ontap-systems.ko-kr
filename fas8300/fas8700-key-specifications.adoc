...
sidebar: sidebar 
keywords: FAS8700 specifications, FAS8700 specs, FAS8700 capacity, FAS8700 memory, FAS8700 input output, FAS8700 compliance 
summary: FAS8700 의 주요 사양 
---
= FAS8700 의 주요 사양
:allow-uri-read: 
:icons: font
...
[role="lead"]
다음은 단일 고가용성 쌍의 FAS8700 스토리지 시스템에 대한 선택 사양입니다.  이 스토리지 시스템의 전체 사양을 보려면 NetApp Hardware Universe (HWU)를 방문하세요.



[[fas8700-specifications-at-a-glance]]
== FAS8700 사양을 한눈에 보기

* 플랫폼 구성: FAS8700 단일 섀시 HA 쌍, 이더넷 번들
* 최대 원시 용량: 15.0000 PB
* 메모리: 512.0000GB
...
* 유형: NAS; HA 쌍: 12; 원시 용량: 180.0PB / 159.9PiB; 최대 메모리: 6144GB
* 유형: SAN; HA 쌍: 6; 원시 용량: 90.0PB / 79.9PiB; 최대 메모리: 3072GB
* 유형: HA 쌍; 원시 용량: 15.0 PB / 13.3 PiB; 최대 메모리: 512.0000
