...
summary: 시스템에서 모듈이 오프라인 상태가 되었다는 AutoSupport 메시지가 한 번이라도 발생하면 컨트롤러 모듈의 캐싱 모듈을 교체해야 합니다. 
---
...
NOTE: 슬롯 6은 FAS8300 VER2 컨트롤러에서만 사용할 수 있습니다.
...
+
구성에 따라 컨트롤러 모듈에 0, 1 또는 2개의 캐싱 모듈이 있을 수 있습니다. 컨트롤러 모듈 내부의 FRU 맵을 사용하여 캐싱 모듈을 찾을 수 있습니다.
