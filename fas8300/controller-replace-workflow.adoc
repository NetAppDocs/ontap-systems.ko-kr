---
permalink: fas8300/controller-replace-workflow.html 
sidebar: sidebar 
keywords: fas8300, fas8700, replace the controller workflow 
summary: 손상된 컨트롤러를 종료하고, 컨트롤러를 제거 및 교체하고, 시스템 구성을 복원하고, 스토리지 리소스의 제어권을 교체 컨트롤러로 반환하여 FAS8300 또는 FAS8700 스토리지 시스템의 컨트롤러를 교체하십시오. 
---
= 컨트롤러 교체 워크플로 - FAS8300 및 FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
손상된 컨트롤러를 종료하고, 컨트롤러를 제거 및 교체하고, 시스템 구성을 복원하고, 스토리지 리소스의 제어권을 교체 컨트롤러로 반환하여 FAS8300 또는 FAS8700 스토리지 시스템의 컨트롤러를 교체하십시오.
...
시스템 호환성, 필요한 도구, ONTAP 자격 증명, 구성 요소 기능 검증을 포함한 컨트롤러 교체 요구 사항을 검토합니다.
...
[role="quick-margin-para"]
손상된 컨트롤러를 제거하고, FRU 구성 요소를 교체 컨트롤러 모듈로 옮긴 다음, 교체 컨트롤러 모듈을 인클로저에 설치합니다.
