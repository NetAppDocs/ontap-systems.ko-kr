...
summary: 스토리지 리소스의 제어권을 교체 컨트롤러로 반환하여 FAS8300 및 FAS8700 시스템이 정상 작동을 재개할 수 있도록 합니다. 
---
= 컨트롤러 반환 - FAS8300 및 FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
스토리지 리소스의 제어권을 교체 컨트롤러로 반환하여 FAS8300 및 FAS8700 시스템이 정상 작동을 재개할 수 있도록 합니다.
