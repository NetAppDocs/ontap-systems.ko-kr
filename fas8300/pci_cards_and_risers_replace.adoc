...
sidebar: sidebar 
keywords: fas8300, fas8700, replace, pcie, mezzanine, card, node, metrocluster, reinstall, controller, aggregate, reinstall, node 
...
== 7단계: 진단 프로그램을 실행한 후 컨트롤러 모듈을 작동 상태로 복원합니다
