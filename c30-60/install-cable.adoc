...
---
= AFF C30 및 AFF C60 하드웨어의 네트워크 및 스토리지 연결을 위한 케이블 연결
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_isi_a30-50_switchless_2p_100gbe_2card_cabling_ieops-2011.svg[100GbE IO 모듈 2개를 사용하는 C30 및 C60 스위치가 없는 클러스터 케이블 연결 다이어그램]
...
+
image::../media/drw_isi_a30-50_switchless_2p_100gbe_1card_cabling_ieops-1925.svg[100GbE IO 모듈 하나를 사용한 c30 및 c60 스위치가 없는 클러스터 케이블링 다이어그램]
...
+
image::../media/drw_isi_a30-50_switched_2p_100gbe_2card_cabling_ieops-2013.svg[100GbE IO 모듈 2개를 사용한 c30 및 c60 스위치 클러스터 케이블링 다이어그램]
