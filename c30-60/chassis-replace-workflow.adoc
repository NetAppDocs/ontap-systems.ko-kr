...
summary: AFF C30 또는 AFF C60 스토리지 시스템의 섀시 교체, 컨트롤러 종료, 섀시 제거 및 교체, 시스템 작업 확인을 통해 섀시 교체를 시작하십시오. 
---
...
[role="lead"]
AFF C30 또는 AFF C60 스토리지 시스템의 섀시 교체, 컨트롤러 종료, 섀시 제거 및 교체, 시스템 작업 확인을 통해 섀시 교체를 시작하십시오.
