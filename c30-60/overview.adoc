...
summary: 단일 고가용성 쌍으로 구성된 AFF C30 및 AFF C60 스토리지 시스템의 주요 사양 
---
= AFF C30 및 AFF C60의 주요 사양
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
다음은 단일 고가용성 쌍으로 구성된 AFF C30 및 AFF C60 스토리지 시스템의 주요 사양입니다. 해당 스토리지 시스템의 전체 사양은 https://hwu.netapp.com["NetApp Hardware Universe를 참조하십시오"^]을 참조하십시오.
