...
summary: 새 부팅 미디어 장치를 AFF C30 또는 AFF C60 스토리지 시스템에 설치한 후 자동 부팅 미디어 복구 프로세스를 시작하여 파트너 노드에서 구성을 복원할 수 있습니다. 복구 프로세스 중에 시스템은 암호화가 활성화되어 있는지 확인하고 사용 중인 키 암호화 유형을 파악합니다. 키 암호화가 활성화된 경우 시스템은 복원에 필요한 적절한 단계를 안내합니다. 
---
= 자동 부팅 복구 프로세스를 사용하여 AFF C30 또는 AFF C60 스토리지 시스템의 부팅 이미지를 복원하십시오.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
새 부팅 미디어 장치를 AFF C30 또는 AFF C60 스토리지 시스템에 설치한 후 자동 부팅 미디어 복구 프로세스를 시작하여 파트너 노드에서 구성을 복원할 수 있습니다. 복구 프로세스 중에 시스템은 암호화가 활성화되어 있는지 확인하고 사용 중인 키 암호화 유형을 파악합니다. 키 암호화가 활성화된 경우 시스템은 복원에 필요한 적절한 단계를 안내합니다.
