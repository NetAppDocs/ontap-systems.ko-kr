...
summary: 교체 요구 사항을 검토하고, 암호화 상태 확인, 컨트롤러 종료, 부팅 미디어 교체, 복구 이미지 부팅, 암호화 복원 및 시스템 기능 확인을 통해 AFF C30 또는 AFF C60 스토리지 시스템의 부팅 미디어 교체를 시작하십시오. 
---
= 부팅 미디어 교체 워크플로우 - AFF C30 및 AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
교체 요구 사항을 검토하고, 암호화 상태 확인, 컨트롤러 종료, 부팅 미디어 교체, 복구 이미지 부팅, 암호화 복원 및 시스템 기능 확인을 통해 AFF C30 또는 AFF C60 스토리지 시스템의 부팅 미디어 교체를 시작하십시오.
