...
sidebar: sidebar 
keywords: AFF C30 specifications, AFF C30 specs, AFF C30 capacity, AFF C30 memory, AFF C30 IO, AFF C30 compliance 
summary: AFF C30의 주요 사양 
---
= AFF C30의 주요 사양
:allow-uri-read: 
:icons: font
...
[role="lead"]
다음은 단일 고가용성 쌍의 AFF C30 스토리지 시스템에 대한 선택 사양입니다.  이 스토리지 시스템의 전체 사양을 보려면 NetApp Hardware Universe (HWU)를 방문하세요.
...
* 유형: NAS; HA 쌍: 4; 원시 용량: 8.8PB / 7.9PiB; 최대 메모리: 512GB
* 유형: SAN; HA 쌍: 4; 원시 용량: 8.8PB / 7.9PiB; 최대 메모리: 512GB
* 유형: HA 쌍; 원시 용량: 2.2PB / 2.0PiB; 최대 메모리: 128.0000
