...
summary: AFF C30 또는 AFF C60 저장 장치 시스템에서 손상된 컨트롤러를 종료하여 데이터 손실을 방지하고 부팅 미디어를 교체할 때 시스템 안정성을 유지합니다. 
---
= 부트 미디어를 교체하려면 컨트롤러를 종료하세요 - AFF C30 및 AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
부트 미디어를 교체할 때 데이터 손실을 방지하고 시스템 안정성을 확보하려면 AFF C30 또는 AFF C60 스토리지 시스템의 컨트롤러를 종료하세요.
