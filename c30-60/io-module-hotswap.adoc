...
summary: 모듈에 오류가 발생하고 스토리지 시스템이 모든 ONTAP 버전 요구 사항을 충족하는 경우 AFF C30 또는 AFF C60 스토리지 시스템에서 Ethernet I/O 모듈을 핫 스왑할 수 있습니다. 
---
= AFF C30 또는 AFF C60 스토리지 시스템에서 I/O 모듈 핫 스왑
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
모듈에 오류가 발생하고 스토리지 시스템이 모든 ONTAP 버전 요구 사항을 충족하는 경우 AFF C30 또는 AFF C60 스토리지 시스템에서 Ethernet I/O 모듈을 핫 스왑할 수 있습니다.
