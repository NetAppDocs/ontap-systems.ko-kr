...
|===
. 스토리지 케이블 연결: link:install_detailed_guide.md#["드라이브 쉘프에 컨트롤러 케이블을 연결합니다"]
...
. 그림 또는 단계별 지침을 사용하여 컨트롤러와 스위치 간의 케이블 연결을 완료할 수 있습니다.
+
image::../media/drw_a320_switched_network_cabling_composite_animated_gif.png[A320 drw 교환 네트워크 케이블 연결 합성 애니메이션 gif]
