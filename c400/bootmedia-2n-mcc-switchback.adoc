...
---
= AFF C400 스토리지 시스템의 2노드 MetroCluster 구성에서 애그리게이트 스위치백
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
2노드 MetroCluster 구성의 AFF C400 스토리지 시스템에서 부팅 미디어 교체를 완료한 후 MetroCluster 스위치백 작업을 수행하여 구성을 정상 작동 상태로 복원하십시오.
