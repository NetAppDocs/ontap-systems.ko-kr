...
sidebar: sidebar 
keywords: ASA A30 specifications, ASA A30 specs, ASA A30 capacity, ASA A30 memory, ASA A30 IO, ASA A30 compliance 
summary: ASA A30의 주요 사양 
---
= ASA A30의 주요 사양
:allow-uri-read: 
:icons: font
...
[role="lead"]
다음은 단일 고가용성 쌍의 ASA A30 스토리지 시스템에 대한 선택 사양입니다.  이 스토리지 시스템의 전체 사양을 보려면 NetApp Hardware Universe (HWU)를 방문하세요.



== 주요 용량, 메모리, 폼 팩터 및 ONTAP 버전 사양

* 플랫폼 구성: ASA A30 단일 섀시 HA 쌍
* 최대 원시 용량: 1.1016 PB
* 메모리: 128.0000GB
...
* 유형: NAS
* 유형: SAN; HA 쌍: 4; 원시 용량: 4.4PB / 3.9PiB; 최대 메모리: 512GB
