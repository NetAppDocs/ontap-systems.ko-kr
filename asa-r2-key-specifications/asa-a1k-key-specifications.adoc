...
sidebar: sidebar 
keywords: ASA A1K specifications, ASA A1K specs, ASA A1K capacity, ASA A1K memory, ASA A1K IO, ASA A1K compliance 
summary: ASA A1K의 주요 사양 
---
= ASA A1K의 주요 사양
:allow-uri-read: 
:icons: font
...
[role="lead"]
다음은 단일 고가용성 쌍의 ASA A1K 스토리지 시스템에 대한 선택 사양입니다.  이 스토리지 시스템의 전체 사양을 보려면 NetApp Hardware Universe (HWU)를 방문하세요.



== 주요 용량, 메모리, 폼 팩터 및 ONTAP 버전 사양

* 플랫폼 구성: ASA A1KA 듀얼 섀시 HA 쌍
* 최대 원시 용량: 2.6622 PB
* 메모리: 2048.0000GB
* 폼 팩터: 1개의 HA 컨트롤러가 있는 2U 섀시
* ONTAP 버전: ONTAP: 9.16.1P2
* PCIe 확장 슬롯: 18개
* 최소 ONTAP 버전: ONTAP 9.16.0
...
* 유형: NAS
* 유형: SAN; HA 쌍: 6; 원시 용량: 16.0PB / 14.2PiB; 최대 메모리: 12288GB
* 유형: HA 쌍; 원시 용량: 2.7PB / 2.4PiB; 최대 메모리: 2048.0000
