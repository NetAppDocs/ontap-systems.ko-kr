...
sidebar: sidebar 
keywords: ASA A50 specifications, ASA A50 specs, ASA A50 capacity, ASA A50 memory, ASA A50 IO, ASA A50 compliance 
summary: ASA A50의 주요 사양 
---
= ASA A50의 주요 사양
:allow-uri-read: 
:icons: font
...
[role="lead"]
다음은 단일 고가용성 쌍의 ASA A50 스토리지 시스템에 대한 선택 사양입니다.  이 스토리지 시스템의 전체 사양을 보려면 NetApp Hardware Universe (HWU)를 방문하세요.



== 주요 용량, 메모리, 폼 팩터 및 ONTAP 버전 사양

* 플랫폼 구성: ASA A50 단일 섀시 HA 쌍
* 최대 원시 용량: 1.8360 PB
* 메모리: 256.0000GB
...
* 유형: NAS
* 유형: SAN; HA 쌍: 6; 원시 용량: 11.0PB / 9.8PiB; 최대 메모리: 1536GB
* 유형: HA 쌍; 원시 용량: 1.8PB / 1.6PiB; 최대 메모리: 256.0000
