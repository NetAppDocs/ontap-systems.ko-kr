...
summary: AFF A70 또는 AFF A90 시스템에서 부팅 미디어를 교체하기 전에 올바른 교체를 위해 필요한 요구 사항을 충족해야 합니다. 여기에는 올바른 교체 부팅 장치가 있는지 확인, 시스템 펌웨어 및 ONTAP 소프트웨어에 대한 액세스, 필수 구성 데이터 백업이 포함됩니다. 
---
...
[role="lead"]
AFF A70 또는 AFF A90 시스템에서 부팅 미디어를 교체하기 전에 올바른 교체를 위해 필요한 요구 사항을 충족해야 합니다. 여기에는 올바른 교체 부팅 장치가 있는지 확인, 시스템 펌웨어 및 ONTAP 소프트웨어에 대한 액세스, 필수 구성 데이터 백업이 포함됩니다.
