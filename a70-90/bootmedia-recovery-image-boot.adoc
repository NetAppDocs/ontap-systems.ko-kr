...
summary: AFF A70 또는 AFF A90 시스템의 부팅 미디어가 손상된 경우 USB 드라이브에서 복구 이미지를 부팅하고 파트너 노드에서 구성을 복원할 수 있습니다. 
---
...
[role="lead"]
AFF A70 또는 AFF A90 시스템의 부팅 미디어가 손상된 경우 USB 드라이브에서 복구 이미지를 부팅하고 파트너 노드에서 구성을 복원할 수 있습니다.
