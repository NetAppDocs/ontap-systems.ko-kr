...
[role="lead"]
다음은 단일 고가용성 쌍의 AFF A70 스토리지 시스템에 대한 선택 사양입니다.  이 스토리지 시스템의 전체 사양을 보려면 NetApp Hardware Universe (HWU)를 방문하세요.
...
* 유형: NAS; HA 쌍: 12; 원시 용량: 79.3PB / 70.4PiB; 최대 메모리: 3072GB
* 유형: SAN; HA 쌍: 6; 원시 용량: 39.7PB / 35.2PiB; 최대 메모리: 1536GB
* 유형: HA 쌍; 원시 용량: 6.6PB / 5.9PiB; 최대 메모리: 256.0000
...
* 깊이: 34.5인치 (케이블 정리 브래킷 포함 시 36.6인치)
