...
[role="lead"]
손상된 컨트롤러를 종료하고, 컨트롤러를 제거 및 교체하고, 시스템 구성을 복원하고, 스토리지 리소스 제어를 교체 컨트롤러로 반환하여 AFF A70 또는 AFF A90 스토리지 시스템의 컨트롤러를 교체합니다.
