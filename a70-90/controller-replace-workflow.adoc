...
summary: AFF A70 및 AFF A90 컨트롤러 교체에는 컨트롤러 종료, 컨트롤러 제거 및 교체, 시스템 설정 재구성 및 시스템 작업 확인 단계가 포함되어 있습니다. 
---
...
[role="lead"]
AFF A70 및 AFF A90 컨트롤러 교체에는 컨트롤러 종료, 컨트롤러 제거 및 교체, 시스템 설정 재구성 및 시스템 작업 확인 단계가 포함되어 있습니다.
