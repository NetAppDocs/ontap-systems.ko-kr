...
summary: 컨트롤러를 재부팅하고 시스템 상태를 확인한 다음 장애가 발생한 부품을 NetApp에 반환하여 AFF A70 및 AFF A90 섀시 교체 워크플로우의 최종 단계를 완료합니다. 
---
...
[role="lead"]
컨트롤러를 재부팅하고 시스템 상태를 확인한 다음 장애가 발생한 부품을 NetApp에 반환하여 AFF A70 및 AFF A90 섀시 교체 워크플로우의 최종 단계를 완료합니다.
