...
summary: 지나치게 수정 가능하거나 수정할 수 없는 오류가 감지되면 AFF A70 또는 AFF A90 시스템의 DIMM을 교체합니다. 이러한 문제는 종종 단일 DIMM 장애로 인해 스토리지 시스템이 ONTAP를 부팅하지 못할 수 있습니다. 
---
= DIMM-AFF A70 및 AFF A90를 교체합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
지나치게 수정 가능하거나 수정할 수 없는 오류가 감지되면 AFF A70 또는 AFF A90 시스템의 DIMM을 교체합니다. 이러한 문제는 종종 단일 DIMM 장애로 인해 스토리지 시스템이 ONTAP를 부팅하지 못할 수 있습니다.
