...
+
https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=256721fd-4c2e-40b3-841a-adf2000df5fa["애니메이션 -- 컨트롤러를 제거합니다"^]
...
+
image::../media/drw_a900_DIMM_map.png[drw a900 DIMM 맵]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=db161030-298a-4ae4-b902-adf2000e2aa4["애니메이션 -- DIMM을 교체합니다"^]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=099237f3-d7f2-4749-86e2-adf2000df53c["애니메이션 -- 컨트롤러 설치"^]
...
IMPORTANT: 부팅 과정 중에 메시지에 안전하게 'y'로 응답할 수 있습니다.

+
*** HA 구성에서 유지보수 모드로 전환할 때 정상 상태인 노드가 계속 중지되어 있는지 확인하는 경고 메시지가 표시되는 경우
