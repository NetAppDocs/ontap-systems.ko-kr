...
X66100-5(112-00544), 5m
 a| 
image::../media/oie_cable100_gbe_qsfp28.svg[GbE 구리 SFP]
 a| 
이더넷 데이터, 클러스터 네트워크
...
X6562-R6(112-00196), 5m
 a| 
image::../media/oie_cable_rj45.svg[RJ-45 케이블 커넥터]
 a| 
관리 네트워크 및 이더넷 데이터
...
해당 없음
 a| 
image::../media/oie_cable_micro_usb.svg[마이크로 USB 커넥터]
 a| 
...
해당 없음
 a| 
image::../media/oie_cable_power.svg[전원 케이블 커넥터]
 a| 
시스템 전원을 켭니다
...
image::../media/oie_cable100_gbe_qsfp28.svg[100Gb 커넥터]
...
image::../media/oie_cable100_gbe_qsfp28.svg[100 GbE 케이블 커넥터]
...
image:../media/oie_cable_power.svg["전원 케이블"]
...
image:../media/oie_cable100_gbe_qsfp28.svg["100 GbE 케이블"]



 a| 
image:../media/oie_legend_icon_2_lo.svg["설명선 아이콘 2"]
 a| 
케이블 컨트롤러 관리(렌치) 포트
...
image::../media/drw_a900fas9500_power_icon_IEOPS-1142.svg[drw a900fas9500 전원 아이콘 IEOPS 1142]
...
image::../media/oie_cable_pull_tab_down.svg[케이블 당김 탭 방향]
...
| 단계 | 각 컨트롤러에서 수행합니다 
 ...
 a| 
image::../media/oie_legend_icon_1_mb.svg[설명 번호 1]
 a| 
** 컨트롤러 A 포트 e2a를 쉘프의 NSM A의 포트 e0a에 연결합니다.
** 컨트롤러 A 포트 e10b를 쉘프의 NSM B의 포트 e0b에 연결합니다.


image::../media/oie_cable100_gbe_qsfp28.svg[100 GbE QSFP 커넥터]
...
100GbE 케이블
 ...
 a| 
image::../media/oie_legend_icon_2_lo.svg[설명 번호 2]
 a| 
