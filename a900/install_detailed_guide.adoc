...
다음 다이어그램에서는 일반적인 시스템의 모양과 주요 구성 요소가 시스템의 판독에 있는 위치를 보여 줍니다.
...
+
image::../media/drw_9000_cable_console_switch_controller_IEOPS-953.svg[drw 9000 케이블 콘솔 스위치 컨트롤러 IEOPS 953]
