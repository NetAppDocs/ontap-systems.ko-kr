...
---
= AFF A900 수동 부팅 복구 과정 중에 AFF A900 시스템의 컨트롤러를 종료하십시오.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
데이터 손실을 방지하고 수동 부팅 복구 과정 중 시스템 안정성을 유지하려면 AFF A900 스토리지 시스템에서 손상된 컨트롤러를 종료하십시오.
...
스토리지 시스템에서 ONTAP 9.17.1 이상을 실행 중인 경우 자동 부팅 복구 절차를 사용하세요.  시스템에서 이전 버전의 ONTAP 실행 중인 경우 수동 부팅 복구 프로세스를 사용해야 합니다.
