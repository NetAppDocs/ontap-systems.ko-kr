...
[role="lead"]
AFF A900 시스템의 LED USB 모듈을 교체하여 콘솔 포트 연결 및 시스템 상태를 복원하십시오. 교체에는 도구가 필요하지 않으며 서비스 중단도 없습니다.
...
+
image::../media/drw_a900_remove_replace_LED_mod.svg[LED USB 모듈을 분리합니다]
