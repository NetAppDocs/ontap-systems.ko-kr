...
summary: 정확한 시간 동기화에 의존하는 시스템의 서비스 및 애플리케이션이 계속 작동하도록 컨트롤러 모듈의 실시간 클록 배터리를 교체합니다. 
---
= AFF A900 시스템의 실시간 클록 배터리를 교체하십시오.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
정확한 시간 동기화에 의존하는 서비스 및 애플리케이션이 계속 작동하도록 AFF A900 시스템의 실시간 클록(RTC) 배터리를 교체하십시오.
...
+
image::../media/drw_a900_remove_RTC_battery.svg[RTC 배터리를 탈거한 후 장착하십시오]
...
[[step-4-reinstall-the-controller-module-and-set-timedate]]
