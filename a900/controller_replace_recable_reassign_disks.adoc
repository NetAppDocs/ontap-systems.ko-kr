...
summary: 스토리지 및 네트워크 구성을 다시 연결하여 교체 절차를 계속 진행하십시오. 
---
= AFF A900 시스템의 케이블을 다시 연결하고 디스크를 재할당합니다.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
스토리지 및 네트워크 구성을 다시 연결하고 NetApp Storage Encryption을 복원하여 AFF A900 시스템을 정상적으로 작동시키십시오.
...
컨트롤러 모듈의 스토리지 및 네트워크 연결을 다시 시작해야 합니다.
