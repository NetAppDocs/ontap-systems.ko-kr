...
+
image::../media/drw_asac800_weight_caution.png[drw asac800 무게 주의]

. 케이블 관리 장치를 연결합니다(그림 참조).
+
image::../media/drw_asac800_install_cable_mgmt.png[drw asac800 설치 케이블 관리]
...
image:../media/oie_legend_icon_3_lp.png[""]
 a| 
관리 네트워크 스위치에 관리 포트를 케이블로 연결합니다    image:../media/drw_asac800_mgmt_cabling.png["시스템 뒷면의 관리 포트 위치를 보여 주는 그림입니다"]
...
1
 a| 
포트 2a에서 2D를 FC 호스트 스위치에 케이블로 연결합니다.image:../media/drw_asac800_fc_host_cabling.png[""]
...
1
 a| 
케이블 포트 e4a~e4d를 10GbE 호스트 네트워크 스위치에 연결합니다.image:../media/drw_asac800_10gbe_host_cabling.png[""]
...
image:../media/oie_legend_icon_1_mb.png[""]
 a| 
컨트롤러 A를 쉘프에 연결:    image:../media/drw_asac800_1shelf_cabling_a.png[""]
...
image:../media/oie_legend_icon_2_lo.png[""]
 a| 
컨트롤러 B를 쉘프에 연결:    image:../media/drw_asac800_1shelf_cabling_b.png[""]
...
image:../media/oie_legend_icon_1_mb.png[""]
 a| 
컨트롤러 A를 쉘프에 연결:    image:../media/drw_asac800_2shelf_cabling_a.png[""]
...
image:../media/oie_legend_icon_2_lo.png[""]
 a| 
컨트롤러 B를 쉘프에 연결:    image:../media/drw_asac800_2shelf_cabling_b.png[""]
...
+
image::../media/drw_console_connect_asac800.png[DRW 콘솔이 asac800을 연결합니다]

.. 랩톱 또는 콘솔을 관리 서브넷의 스위치에 연결합니다.
+
image::../media/drw_client_mgmt_subnet_asac800.png[drw 클라이언트 관리 서브넷 asac800]
