...
sidebar: sidebar 
keywords: aff c80 maintenance, maintenance, repairing aff c80, repairing c80, replace c80 components 
...
---
= AFF C80 스토리지 시스템 유지 관리에 대해 알아보기
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
AFF C80 저장 시스템의 경우 다음 구성 요소에 대한 유지 관리 절차를 수행할 수 있습니다.
...
link:system-management-replace.html["시스템 관리 모듈"]
 a| 
시스템 관리 모듈은 컨트롤러나 시스템 유지관리 목적으로 컨트롤러와 콘솔 또는 랩톱 간의 인터페이스를 제공합니다.  시스템 관리 모듈에는 부팅 미디어가 포함되어 있으며 시스템 일련 번호(SSN)를 저장합니다.
