...
summary: 손상된 컨트롤러를 종료하고, 컨트롤러를 분리 및 교체하고, 시스템 구성을 복원하고, 시스템 작동을 확인하여 AFF C80 스토리지 시스템의 컨트롤러 교체를 시작하십시오. 
---
...
[role="lead"]
손상된 컨트롤러를 종료하고, 컨트롤러를 분리 및 교체하고, 시스템 구성을 복원하고, 시스템 작동을 확인하여 AFF C80 스토리지 시스템의 컨트롤러 교체를 시작하십시오.
