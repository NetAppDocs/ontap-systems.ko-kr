...
summary: AFF C80 스토리지 시스템에서 장애가 발생한 IO 모듈을 동일한 유형의 IO 모듈 또는 다른 유형의 IO 모듈로 교체할 수 있습니다. 또한 빈 슬롯이 있는 시스템에 IO 모듈을 추가할 수도 있습니다. 
---
= AFF C80 스토리지 시스템에서 I/O 모듈 추가 및 교체에 대해 알아보기
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
