...
summary: 팬이 고장나거나 효율적으로 작동하지 않으면 시스템 냉각 및 전체 성능에 영향을 줄 수 있는 AFF C80 시스템의 팬 모듈을 교체합니다. 
---
= 팬 모듈 교체 - AFF C80
:allow-uri-read: 
:icons: font
...
[role="lead"]
팬이 고장나거나 효율적으로 작동하지 않으면 시스템 냉각 및 전체 성능에 영향을 줄 수 있는 AFF C80 시스템의 팬 모듈을 교체합니다.
