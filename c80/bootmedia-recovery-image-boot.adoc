...
summary: AFF C80 시스템의 부팅 미디어가 손상된 경우 USB 드라이브에서 복구 이미지를 부팅하고, 파트너 노드에서 구성을 복원하고, 환경 변수를 확인할 수 있습니다 
---
= 복구 이미지를 부팅합니다 - AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF C80 시스템의 부팅 미디어가 손상된 경우 USB 드라이브에서 복구 이미지를 부팅하고, 파트너 노드에서 구성을 복원하고, 환경 변수를 확인할 수 있습니다.
