---
permalink: c80/io-module-hotswap.html 
sidebar: sidebar 
keywords: aff c80, hot swap a cluster ha card, hot swap ethernet client io module, hotswap io module, hot swap io module 
summary: 모듈에 오류가 발생하고 스토리지 시스템이 모든 ONTAP 버전 요구 사항을 충족하는 경우 AFF C80 스토리지 시스템에서 이더넷 IO 모듈을 핫 스왑할 수 있습니다. 
---
= AFF C80 스토리지 시스템에서 I/O 모듈 핫 스왑
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
