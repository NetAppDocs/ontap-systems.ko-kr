...
.스위치 클러스터 케이블링
--
100GbE 케이블을 사용하여 컨트롤러 A 및 B 포트 e1a, e7a를 클러스터 네트워크 스위치 A 및 B에 연결합니다. 단계. 컨트롤러 A의 포트 e1a와 컨트롤러 B의 포트 e1a를 클러스터 네트워크 스위치 A에 연결합니다. 컨트롤러 A의 포트 e7a와 컨트롤러 B의 포트 e7a를 클러스터 네트워크 스위치 B에 연결합니다.
