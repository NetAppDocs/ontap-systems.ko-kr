...
.이 작업에 대해
AFF C80 스토리지 시스템은 NSM100 또는 NSM100B 모듈을 사용하는 NS224 쉘프를 지원합니다. 두 모듈의 주요 차이점은 다음과 같습니다.
