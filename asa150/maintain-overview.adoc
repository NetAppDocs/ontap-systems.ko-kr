...
summary: ASA A150 하드웨어를 유지보수하십시오 
---
= ASA A150 스토리지 시스템 유지 관리에 대해 알아보기
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ASA A150 스토리지 시스템의 경우 다음 구성 요소에 대한 유지보수 절차를 수행할 수 있습니다.
...
////2025년 7월: ontap-systems 370: 이 플랫폼에서 지원되지 않으므로 캐싱 모듈을 삭제했습니다.
