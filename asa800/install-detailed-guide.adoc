...
summary: 이 절에서는 시스템 설치에 대한 자세한 단계별 지침을 제공합니다. 
---
= 자세한 단계별 지침에 따라 ASA A800 스토리지 시스템을 설치합니다.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
이 페이지에서는 ASA A800 시스템 설치를 위한 자세한 단계별 지침을 제공합니다.
...
시스템을 설치하려면 계정을 만들고 시스템을 등록해야 합니다. 또한 시스템에 맞는 케이블 수와 유형을 확인하고 특정 네트워크 정보를 수집해야 합니다.
