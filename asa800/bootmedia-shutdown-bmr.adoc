...
summary: 부팅 미디어를 교체할 때 데이터 손실을 방지하고 시스템 안정성을 확보하려면 ASA A800 스토리지 시스템에서 손상된 컨트롤러를 종료하세요. 
---
= 자동 부팅 복구 프로세스 중에 ASA A800 시스템의 컨트롤러를 종료합니다.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
자동 부팅 미디어 복구 프로세스 동안 데이터 손실을 방지하고 시스템 안정성을 유지하려면 ASA A800 스토리지 시스템에서 손상된 컨트롤러를 종료하세요.
