...
summary: ASA-C800 플랫폼 그룹의 주요 사양 
---
= ASA C800 의 주요 사양
:allow-uri-read: 
:icons: font
...
[role="lead"]
다음은 단일 고가용성 쌍의 ASA C800 스토리지 시스템에 대한 선택 사양입니다. 이 스토리지 시스템의 전체 사양을 보려면 NetApp Hardware Universe (HWU)를 방문하세요.



== ASA C800 의 주요 사양

* 플랫폼 구성: ASA C800 단일 섀시 HA 쌍
* 최대 원시 용량: 7.3680 PB
* 메모리: 1280.0000GB
...
* 작동 온도/고도/습도: 최대 3048m(10000피트) 고도에서 5°C ~ 40°C(41°F ~ 104°F), 상대 습도 8% ~ 90%(비응축)
