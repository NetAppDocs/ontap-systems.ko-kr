...
[role="lead"]
컨트롤러를 재부팅하고 시스템 상태를 확인한 후, 고장난 부품을 NetApp에 반환하여 AFF A1K 시스템의 섀시 교체를 위한 최종 단계를 완료하십시오.
...
컨트롤러가 재부팅된 후 ONTAP를 부팅하고, 컨트롤러를 반환한 다음 시스템 상태를 확인하십시오.
