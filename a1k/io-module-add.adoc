...
sidebar: sidebar 
keywords: aff a1k, add IO module 
summary: AFF A1K 시스템에 입출력 모듈을 추가하여 네트워크 연결을 개선하고 데이터 트래픽을 처리하는 시스템의 기능을 확장합니다. 
---
= AFF A1K 시스템에 I/O 모듈을 추가하여 네트워크 연결성을 향상시킵니다.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A1K 시스템에 입출력 모듈을 추가하여 네트워크 연결을 개선하고 데이터 트래픽을 처리하는 시스템의 기능을 확장합니다.

사용 가능한 빈 슬롯이 있거나 모든 슬롯이 완전히 채워진 경우 AFF A1K 스토리지 시스템에 입출력 모듈을 추가할 수 있습니다.
