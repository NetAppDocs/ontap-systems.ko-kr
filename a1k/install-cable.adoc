...
---
= AFF A1K 하드웨어의 네트워크 및 스토리지 연결을 위한 케이블 연결
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* AFF A1K 컨트롤러의 I/O 슬롯에는 1부터 11까지 번호가 매겨집니다.
+
...
NOTE: 호스트 네트워크 연결에는 e1b 및 e7b 포트를 사용하지 마세요. 별도의 호스트 카드를 사용하세요.
...
.. 포트 e10b를 shelf 1 NSM B 포트 e0b에 연결하십시오.
