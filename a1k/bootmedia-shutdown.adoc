...
summary: AFF A1K 스토리지 시스템에서 손상된 컨트롤러를 종료하여 데이터 손실을 방지하고 수동 부팅 복구 과정 중 시스템 안정성을 유지하십시오. 
---
= 수동 부팅 복구 과정 중에 AFF A1K 시스템의 컨트롤러를 종료합니다.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A1K 스토리지 시스템에서 손상된 컨트롤러를 종료하여 데이터 손실을 방지하고 수동 부팅 복구 과정 중 시스템 안정성을 유지하십시오.
