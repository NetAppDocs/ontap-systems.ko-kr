...
summary: 두 개의 비디오가 있는데, 하나는 시스템을 랙에 장착하고 케이블을 연결하는 방법을 보여주고, 다른 하나는 System Manager Guided Setup을 사용하여 초기 시스템 구성을 수행하는 예를 보여줍니다. 
---
= 동영상 안내를 통해 ASA C250 스토리지 시스템을 설치하십시오.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
