...
---
= 섀시 교체를 위해 ASA C250 컨트롤러를 종료합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF ASA C250 스토리지 시스템에서 섀시를 교체할 때 데이터 손실을 방지하고 시스템 안정성을 보장하려면 컨트롤러를 종료하십시오.
...
.다음 단계
컨트롤러를 종료한 후 link:chassis-replace-move-hardware.html["하드웨어를 새 섀시로 이동합니다"]
