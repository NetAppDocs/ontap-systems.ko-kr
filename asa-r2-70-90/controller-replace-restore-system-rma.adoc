...
summary: ASA A70 또는 ASA A90 시스템의 컨트롤러 교체를 완료하려면 먼저 필요에 따라 NetApp Storage Encryption 구성을 복원하십시오. 그런 다음 논리 인터페이스가 홈 포트로 보고하는지 확인하고 클러스터 상태 점검을 수행하십시오. 마지막으로 고장난 부품을 NetApp으로 반환하십시오. 
---
= ASA A70 또는 ASA A90 시스템의 컨트롤러 교체를 완료합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
