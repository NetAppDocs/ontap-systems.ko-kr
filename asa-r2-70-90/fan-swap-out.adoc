...
summary: ASA A70 또는 ASA A90 시스템에서 팬이 고장나거나 효율적으로 작동하지 않는 경우 팬 모듈을 교체하여 시스템 냉각 및 전체 성능에 영향을 줄 수 있습니다. 
---
...
[role="lead"]
ASA A70 또는 ASA A90 시스템에서 팬이 고장나거나 효율적으로 작동하지 않는 경우 팬 모듈을 교체하여 시스템 냉각 및 전체 성능에 영향을 줄 수 있습니다.
