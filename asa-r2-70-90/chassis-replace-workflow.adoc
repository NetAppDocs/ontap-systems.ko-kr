...
summary: 컨트롤러를 종료하고 섀시를 교체하며 시스템 작동을 확인하여 ASA A70 또는 ASA A90 스토리지 시스템의 섀시를 교체하는 작업을 시작하십시오. 
---
...
[role="lead"]
컨트롤러를 종료하고 섀시를 교체하며 시스템 작동을 확인하여 ASA A70 또는 ASA A90 스토리지 시스템의 섀시를 교체하는 작업을 시작하십시오.
