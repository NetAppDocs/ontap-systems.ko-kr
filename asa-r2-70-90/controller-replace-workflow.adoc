...
summary: ASA A70 또는 ASA A90 저장 장치 시스템의 컨트롤러를 교체하고, 컨트롤러를 분리 및 교체하고, 시스템 구성을 복원하고, 시스템 작동을 확인하여 컨트롤러를 교체하는 작업을 시작하십시오. 
---
...
[role="lead"]
ASA A70 또는 ASA A90 저장 장치 시스템의 컨트롤러를 교체하고, 컨트롤러를 분리 및 교체하고, 시스템 구성을 복원하고, 시스템 작동을 확인하여 컨트롤러를 교체하는 작업을 시작하십시오.
